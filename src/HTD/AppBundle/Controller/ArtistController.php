...
use HTD\AppBundle\Entity\Artist;
use HTD\AppBundle\Form\ArtistType;
...
class ArtistController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HTDAppBundle:Artist')->findAll();
     ...
     * @Method("POST")
     * @Template("HTDAppBundle:Artist:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HTDAppBundle:Artist')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HTDAppBundle:Artist:edit.html.twig")
     */
